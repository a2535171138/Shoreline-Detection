...
class DecoderBlock(nn.Module):
    ...
    def forward(self, x, skip=None):
        ...
        if skip is not None:
            ...
            # resize !!!!!!!!!!!!!!!!!!!!!
            # if x.size() != skip.size():
            #     skip = nn.functional.interpolate(skip, size=x.size()[2:], mode='bilinear', align_corners=False)
        ...
        for layer_idx in range(len(self.in_channels) - 1):
            for depth_idx in range(self.depth - layer_idx):
                if layer_idx == 0:
                    ...
                    # resize!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                    # dense_l_i = features[dense_l_i + 1]
                    # dense_l_i = nn.functional.interpolate(dense_l_i, size=cat_features.size()[2:], mode='bilinear', align_corners=False)
...
class SegmentationHead(nn.Sequential):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=5, upsampling=1):
